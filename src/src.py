...
Carpeta SRC de procesamiento de habla (código de aplicación)
"""
...
data_dir = '/content/drive/MyDrive/carpeta_archivos_de_audios.wav'
...
for file in file_list:
    ...
    audio_data, sr = librosa.load("archivos_de_audios.wav", sr=None)
